...
public class CheatsSystem : MonoBehaviour
{
    ...
    public void UsePremadeDocuments()
    {
        ...
        docManager.CreateDocument("Conversación de whatsapp", DocumentType.Report, "Se adjunta una conversacion de whatsapp donde Ana ignora las advertencias de que le están formando zonas humedas en el techo. Pedro advierte varias ocasiones y no recibe respuesta.", true, 500, false, false);
        docManager.CreateDocument("Factura de reparación de daños", DocumentType.ReceiptFacture, "", true, 500, false, false);
        docManager.CreateDocument("Testimonio de vecinos sobre la actitud de Ana", DocumentType.Witness, "Yo, Fran Bernabé, soy vecino del edificio, y rara vez he visto a Ana ser amable o saludar a vecinos. Además hace mucho que no la veo en juntas de comunidad de vecinos, se podría decir que nos tiene olvidados.", true, 500, false, false);
